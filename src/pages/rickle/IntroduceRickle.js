    ...
    try {
      ...
      if (ethereum.chainId === chainParams[network.toLowerCase()].chainId) {
        ...
        try {
          ...
          window.confirm("Add this icon to your wallet?") ? await addTokenImage() : console.log("Sorry Couldn't add the Icon.")
        } catch (error) {
        }
    }
      ...
      >
        ...
        >
          ...
          <Typography
            ...
            pr={{ xs: 2, lg: 20 }}
          >
            Rickle has partnered with M.A.D. Computer Consulting to utilize
          ...
          >
            ...
            networks an has been bridged to make it easier to move around to the
            networks you utilize.
          </Typography>
          <Typography
            my={4}
            mt={3.5}
          ...
          >
            ...
            another $60? Let’s be honest, it can be difficult to get started in
          ...
          >
            ...
            network or use Rickle on Ethereum, Gnosis, Polygon, Binance or
            Harmony One!
          </Typography>
          <Grid
            container
          ...
          >
            ...
            >
              {Object.keys(tokenAddress).map((k, i) => (
                <Grid key={i} display="flex" alignItems="center">
                  <img
                    src={RickleLogo}
                  ...
                  <Tooltip
                    ...
                    title={
                      copyText === tokenAddress[k] ? "Copied" : "Click to copy"
                    }
                    placement="top"
                  >
                    <Typography
          ...
          <Grid container justifyContent={{ xs: "center", lg: "start" }}>
            <Grid item ml={{ xs: 0, lg: 10 }}>
              <Button
